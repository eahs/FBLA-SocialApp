...
using FBLASocialApp.Models.About;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace FBLASocialApp.ViewModels.About
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:FBLASocialApp.ViewModels.About.AboutUsViewModel"/> class.
        /// </summary>
